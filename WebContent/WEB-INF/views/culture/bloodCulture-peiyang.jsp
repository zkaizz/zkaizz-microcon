...
<%@ include file="/common/global.jsp"%>
    ...
    <script src="${ctx }/js/module/culture/bloodCulture-peiyang.js" type="text/javascript"></script>
    <script type="text/javascript">
    $(function() {
...
<body>
	...
	<form id="inputForm"  method="post" class="form-bloodCulture">
		<fieldset>
			...
			<a id="cancel" href="${ctx }/bloodCulture/task/list"/>
			<input type="button" value="取消" onclick="javascript:$('#cancel').click();">
			</div>
		</fieldset>
	</form>
	</div>
